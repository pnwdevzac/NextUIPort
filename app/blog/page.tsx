...
export default function BlogPage() {
  ...
  return (
    <div>
      <h1>Computing Eras</h1>
      <ButtonGroup>
        <Button color="primary" onClick={slowDownAnimation}>Slow Down</Button>
        <Button color="secondary" onClick={speedUpAnimation}>Speed Up</Button>
...
<div className="grid-container">
  {computingEras.map((era, index) => (
    <div key={index} className="era-container">
      ...
      <img src={era.image} alt={`Image of ${era.era}`} />
    </div>
  ))}
</div>
